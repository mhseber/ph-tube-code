...
const displayVideos = (videos) => {
    ...
    videos.forEach((video) => {
      ...
      alt="Shoes" />
      ${video.others.posted_date?.length == 0 ? "" : `<span class=" text-xs right-2 bottom-2 bg-black text-white rounded p-1 absolute"> ${getTimeString(video.others.posted_date)}</span>`
            }
